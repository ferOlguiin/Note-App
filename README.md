Hola compañero/a programador/a para el caso en el que clones esta repositorio necesitaras las siguientes variables de entorno (dentro de .env) para hacer funcionar la app, las variables son: 
